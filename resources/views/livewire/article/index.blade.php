            ...
            <table class="table table-index w-full">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.article.fields.published') }}
                ...
                <tbody>
                    @forelse($articles as $article)
                        <tr>
                            ...
                            <td>
                                @foreach($article->image as $key => $entry)
                            ...
                            <td>
                                <input class="disabled:opacity-50 disabled:cursor-not-allowed" type="checkbox" disabled {{ $article->published ? 'checked' : '' }}>
                            </td>
                            <td>
                                {{ $article->created_at }}
                            </td>
