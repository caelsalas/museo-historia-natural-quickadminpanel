            ...
            <table class="table table-index w-full">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.collection.fields.content') }}
                            @include('components.table.sort', ['field' => 'content'])
                        </th>
                        <th>
                            {{ trans('cruds.collection.fields.image') }}
                        </th>
                        <th>
                            {{ trans('cruds.collection.fields.published') }}
                            @include('components.table.sort', ['field' => 'published'])
                        </th>
                        <th>
                            {{ trans('cruds.collection.fields.created_at') }}
                ...
                <tbody>
                    @forelse($collections as $collection)
                        <tr>
                            ...
                            <td>
                                @foreach($collection->image as $key => $entry)
                            ...
                            <td>
                                <input class="disabled:opacity-50 disabled:cursor-not-allowed" type="checkbox" disabled {{ $collection->published ? 'checked' : '' }}>
                            </td>
                            <td>
